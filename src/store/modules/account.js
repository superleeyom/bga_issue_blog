...
const state = {
  ...
  auth: {
    ...
    clientID: '438e158196e2c2fd08f9',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: 'd468da4e85c7d9393b9f3fa757328651ece71921'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'superleeyom',  // 修改成你自己的 GitHub 账号
  copyright: '2020',  // 修改成你自己的
  recordNumber: '粤ICP备17147440号',  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'superleeyom/blog',  // 记录 Issue 的仓库的全名「用户名/仓库名」
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/superleeyom'  // 第三方站点的 url
    }
